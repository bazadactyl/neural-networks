...
We have provided an easy-to-use Makefile to help you run our program:
    ...
    \begin{Verbatim}[frame=single,commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{make} \PY{n}{prepare}\PY{o}{\PYZhy{}}\PY{n}{venv}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} Syntax}
...
\tightlist
\item
  import the LFW face data from local files (provided with our
  submission)
\item
  perform 10-fold cross-validation; for each fold do:
  ...
  \end{itemize}
\item
  compute the average accuracy over the 10 folds and print it out
\end{enumerate}
...
cross validation, along with the following hyper-parameters:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} Hyper\PYZhy{}parameters}
...
We used scikit-learn to perform PCA on the input face data:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{num\PYZus{}components} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{sys}\PY{o}{.}\PY{n}{argv}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
...
average accuracy over the 10 folds
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k}{for} \PY{n}{fold} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}folds}\PY{p}{)}\PY{p}{:}
